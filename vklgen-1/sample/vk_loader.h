...
typedef struct VkInfo{
	// instance extensions
	VkBool32 EXT_debug_report;
	VkBool32 KHR_surface;
	VkBool32 KHR_display;
	VkBool32 KHR_xlib_surface;
	VkBool32 KHR_xcb_surface;
	VkBool32 KHR_wayland_surface;
	VkBool32 KHR_mir_surface;
	VkBool32 KHR_android_surface;
	VkBool32 KHR_win32_surface;

	// device extensions
	VkBool32 KHR_swapchain;
